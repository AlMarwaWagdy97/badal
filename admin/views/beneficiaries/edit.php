...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="<?php echo ADMINURL . '/beneficiaries/edit/' . $data['beneficiary_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group  <?php echo (empty($data['district_error'])) ?: 'has-error'; ?>">
                        <label class="control-label" for="pageTitle">الحي : </label>
                        <div class="has-feedback">
                            <input type="text" class="form-control" name="district" placeholder="عنوان الحي" value="<?php echo $data['district']; ?>">
                            <span class="fa fa-edit form-control-feedback" aria-hidden="true"></span>
                            <span class="help-block"><?php echo $data['district_error']; ?></span>
                        </div>
                    </div>
                    <div class="form-group  <?php echo (empty($data['city_error'])) ?: 'has-error'; ?>">
                        ...
                        <div class="has-feedback">
                            ...
                            <span class="fa fa-edit form-control-feedback" aria-hidden="true"></span>
                            <span class="help-block"><?php echo $data['city_error']; ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group  <?php echo (empty($data['family_error'])) ?: 'has-error'; ?>">
                        <label class="control-label" for="pageTitle">عدد افراد الاسرة : </label>
                        <div class="has-feedback">
                            <input type="text" class="form-control" name="family" placeholder=" عدد افراد الاسرة" value="<?php echo $data['family']; ?>">
                            <span class="fa fa-edit form-control-feedback" aria-hidden="true"></span>
                            <span class="help-block"><?php echo $data['family_error']; ?></span>
                        </div>
                    </div>
                    <div class="form-group  <?php echo (empty($data['income_error'])) ?: 'has-error'; ?>">
                        <label class="control-label" for="pageTitle">الدخل : </label>
                        <div class="has-feedback">
                            <input type="text" class="form-control" name="income" placeholder=" الدخل" value="<?php echo $data['income']; ?>">
                            <span class="fa fa-edit form-control-feedback" aria-hidden="true"></span>
                            <span class="help-block"><?php echo $data['income_error']; ?></span>
                        </div>
                    </div>
