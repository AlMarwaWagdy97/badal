...
<div class="right_col" role="main">
    ...
    <div class="clearfix"></div>
    <div class="row">
        <form action="<?php echo ADMINURL . '/appsections/add'; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="col-lg-4 col-sm-12 col-xs-12 options">
                ...
                <div class="accordion">
                    <div class="card">
                        <div class="card-header" data-toggle="collapse" data-target="#collapseOne" aria-controls="collapseOne">
