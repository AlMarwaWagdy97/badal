...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <div class="title_left">
            <a href="<?= ADMINURL; ?>/appsections" class="btn btn-success pull-left">عودة <i class="fa fa-reply"></i></a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="<?= ADMINURL . '/appsections/edit/' . $data['section_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
