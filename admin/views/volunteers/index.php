...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <div class="title_left">
            <a href="<?php echo ADMINURL; ?>/volunteers/add" class="btn btn-success pull-left">انشاء جديد <i class="fa fa-plus"></i></a>
            <a href="<?php echo ADMINURL; ?>/settings/edit/10#volunteer" class="btn btn-primary pull-left">الاعدادات <i class="fa fa-plus"></i></a>
        </div>
    </div>
            ...
            <form action="" method="post">
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            <?php foreach ((object) $data['volunteers'] as $volunteer) : ?>
                                <tr class="even pointer <?php echo $volunteer->status ? '' : ' selected '; ?>">
                                    <td class="a-center">
                                        <input type="checkbox" class="records flat" name="record[]" value="<?php echo $volunteer->volunteer_id; ?>">
                                    </td>
                                    <td class=""><?php echo $volunteer->full_name; ?></td>
                                    <td class=""><?php echo $volunteer->identity; ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo URLROOT . "/media/files/volunteers/" . $volunteer->image; ?>" target="blank">
                                            <img src="<?php echo URLROOT . "/media/files/thumbs/" . $volunteer->image; ?>" height="30px">
                                        </a>
                                    </td>
                                    <td class=""><?php echo $volunteer->phone; ?></td>
                                    <td class=""><?php echo $volunteer->email; ?></td>
                                    <td class=""><?php echo $volunteer->gender; ?></td>
                                    <td class=""><?php echo $volunteer->nationality; ?></td>
                                    <td class="ltr"><?php echo date('Y/ m/ d | H:i a', $volunteer->create_date); ?></td>
                                    <td class="ltr"><?php echo date('Y/ m/ d | H:i a', $volunteer->modified_date); ?></td>
                                    <td class="form-group">
                                        <?php
                                        if (!$volunteer->status) {
                                            echo '<a href="' . ADMINURL . '/volunteers/publish/' . $volunteer->volunteer_id . '" class="btn btn-xs btn-warning" type="button" data-toggle="tooltip" data-original-title="غير مقروء"><i class="fa  fa-envelope-o"></i></a>';
                                        } elseif ($volunteer->status == 1) {
                                            echo '<a href="' . ADMINURL . '/volunteers/unpublish/' . $volunteer->volunteer_id . '" class="btn btn-xs btn-success" type="button" data-toggle="tooltip" data-original-title="مقروء"><i class="fa fa-envelope"></i></a>';
                                        }
                                        ?>
                                        <a href="<?php echo ADMINURL . '/volunteers/show/' . $volunteer->volunteer_id; ?>" class="btn btn-xs btn-success" data-placement="top" data-toggle="tooltip" data-original-title="عرض"><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo ADMINURL . '/volunteers/edit/' . $volunteer->volunteer_id; ?>" class="btn btn-xs btn-primary" data-placement="top" data-toggle="tooltip" data-original-title="تعديل"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo ADMINURL . '/volunteers/delete/' . $volunteer->volunteer_id; ?>" class="btn btn-xs btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="حذف" onclick="return confirm('Are you sure?') ? true : false"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            ...
                            <tr class="tab-selected">
                                ...
                                <th class="column-title"> عرض
                                    <select name="perpage" onchange="if (this.value)
                                                window.location.href = '<?php echo ADMINURL . '/volunteers/index/' . $data['current']; ?>' + '/' + this.value">
                ...
                <ul class="pagination text-center">
                    <?php
                    pagination($data['recordsCount'], $data['current'], $data['perpage'], 4, ADMINURL . '/volunteers');
                    ?>
                </ul>
