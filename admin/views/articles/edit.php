...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_right">
            <h3><?php echo $data['page_title']; ?> <small>التعديل علي الموضوع </small></h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="<?php echo ADMINURL . '/articles/edit/' . $data['article_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="col-lg-8 col-sm-12 col-xs-12">
                    <div class="form-group  <?php echo (empty($data['name_error'])) ?: 'has-error'; ?>">
                        <label class="control-label" for="pageTitle">عنوان الموضوع : </label>
                        <div class="has-feedback">
                            <input type="text" class="form-control" name="name" placeholder="عنوان الموضوع" value="<?php echo $data['name']; ?>">
                    ...
                    <div class="form-group <?php echo (empty($data['image_error'])) ?: 'has-error'; ?>">
                        <label class="control-label" for="imageUpload">صورة الموضوع : </label>
                    ...
                    <div class="form-group">
                        <label class="control-label">وصف الموضوع : </label>
                        <textarea rows="5" name="description" class="form-control"><?php echo ($data['description']); ?></textarea>
                    </div>
                <div class="form-group">
                    <label class="control-label">محتوي الموضوع  : </label>
                        <textarea id="ckeditor" name="content" class="form-control ckeditor"><?php echo ($data['content']); ?></textarea>
                </div>
                </div>
                    ...
                    <div class="accordion">
                        <div class="card">
                            ...
                            <div class="form-group col-xs-12 <?php echo (!empty($data['status_error'])) ? 'has-error' : ''; ?>">
                                ...
                                <div class="form-grou">
                                    <label class="control-label">اظهار الوصف في الشريط الاخباري :</label>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" class="flat" <?php echo ($data['news_ticker'] == 1) ? 'checked' : ''; ?> value="1" name="news_ticker"> نعم
                                        </label>
                                        <label>
                                            <input type="radio" class="flat" <?php echo ($data['news_ticker'] == '0') ? 'checked' : ''; ?> value="0" name="news_ticker"> لا
                                        </label>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse card-body" aria-labelledby="headingTwo">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" form-group">
                                        <textarea name="meta_description" class="form-control description" id="description" placeholder="ادرج وصف مختصر عن الموضوع"><?php echo $data['meta_description']; ?></textarea>
                                    </div>
                                </div>
