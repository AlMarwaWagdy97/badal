...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_right">
            <h3><?php echo $data['page_title']; ?> <small>اضافة  موضوع جديد </small></h3>
        </div>
    ...
    <div class="row">
        ...
        <form action="<?php echo ADMINURL . '/articles/add'; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" >
