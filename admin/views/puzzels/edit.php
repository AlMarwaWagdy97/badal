...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="<?php echo ADMINURL . '/puzzels/edit/' . $data['puzzel_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="col-lg-8 col-sm-12 col-xs-12">
                ...
                <div class="form-group <?php echo (!empty($data['image_error'])) ? 'has-error' : ''; ?>">
                    ...
                    <div class="has-feedback input-group">
                        <span class="input-group-btn">
                            ...
                            <input name="image" value="" onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;" type="file">
                        </span>
                ...
                <div class="form-group <?php echo (!empty($data['image2_error'])) ? 'has-error' : ''; ?>">
                    ...
                    <div class="has-feedback input-group">
                        <span class="input-group-btn">
                            <span class="btn btn-dark" onclick="$(this).parent().find('input[type=file]').click();">اختار الملف</span>
                            <input name="image2" value="" onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;" type="file">
                        </span>
                        ...
                        <div id="collapseOne" class="collapse card-body in" aria-labelledby="headingOne">
                            <div class="form-group col-xs-12 <?php echo (!empty($data['status_error'])) ? 'has-error' : ''; ?>">
                                ...
                                <div class="radio">
                                    ...
                                    <label>
                                        <input type="radio" class="flat" <?php echo ($data['status'] != 1) ? 'checked' : ''; ?> value="0" name="status"> غير منشور
                                    </label>
                        ...
                        <div id="collapseOne" class="collapse card-body in" aria-labelledby="headingOne">
                            <div class="form-group col-xs-12 <?php echo (!empty($data['rotate_error'])) ? 'has-error' : ''; ?>">
                                ...
                                <div class="radio">
                                    ...
                                    <label>
                                        <input type="radio" class="flat" <?php echo ($data['rotate'] == '0') ? 'checked' : ''; ?> value="0" name="rotate"> بدون دوران
                                    </label>
