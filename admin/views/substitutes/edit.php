...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_right">
            <h3><?php echo $data['page_title']; ?> <small>التعديل علي مقدمي الخدمة </small></h3>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="<?php echo ADMINURL . '/substitutes/edit/' . $data['substitute_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group  <?php echo (empty($data['languages_error'])) ?: 'has-error'; ?>">
                        ...
                        <div class="row">
                            ...
                            <span class="help-block"><?php echo $data['languages_error']; ?></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion">
                        <div class="card">
                            ...
                            <div class="form-group col-xs-12">
                                    ...
                                    <input type="number" step="_any" class="form-control" name="proportion" value="<?php echo @$data['proportion']; ?>">
                                </div>
