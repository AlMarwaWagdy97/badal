                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead class="fixme">
                            <tr class="headings orders">
                                ...
                                <th class="column-title"> الصفة </th>
                                <th class="column-title"> اللغه </th>
                                <th class="column-title"> جنس المعتمر </th>

                                <th class="column-title">المشروع
                                    <select class="select2" multiple name="search[projects][]">
                                        <?php
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        <?php if ($order->rate != null ){  ?>
                                            <span class="stars-container stars-<?= ($order->rate / 5) * 100 ?>">★★★★★</span>
                                         <?php } ?>
                                    </td>
                                    <td class="form-group w200" colspan="4" style="    white-space: nowrap;">
                                        <?php
                                        if (!$order->status) {
