...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <div class="title_left">
            <a href="<?php echo ADMINURL; ?>/menus/add" class="btn btn-success pull-left">انشاء جديد <i class="fa fa-plus"></i></a>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form action="" method="post" >
                        ...
                        <tbody>
                            <?php foreach ($data['menus'] as $menu): ?>
                                ...
                                <tr class="even pointer">
                                    <td class="a-center ">
                                        <input type="checkbox" class="records flat" name="record[]" value="<?php echo $menu->menu_id; ?>">
                                    </td>
                                    <td class=" "><?php echo str_repeat('ـــ ', $menu->level - 1) . $menu->name; ?></td>
                                    <td class=" "><?php echo $menu->url; ?></td>
                                    <td class=" "><?php echo $menu->arrangement; ?></td>
                                    <td class="ltr"><?php echo date('Y/ m/ d | H:i a', $menu->create_date); ?></td>
                                    <td class="ltr"><?php echo date('Y/ m/ d | H:i a', $menu->modified_date); ?></td>
                                    <td class="form-group">
                                        <?php
                                        if (!$menu->status) {
                                            echo '<a href="' . ADMINURL . '/menus/publish/' . $menu->menu_id . '" class="btn btn-xs btn-warning" type="button" data-toggle="tooltip" data-original-title="غير منشور"><i class="fa fa-ban"></i></a>';
                                        } elseif ($menu->status == 1) {
                                            echo '<a href="' . ADMINURL . '/menus/unpublish/' . $menu->menu_id . '" class="btn btn-xs btn-success" type="button" data-toggle="tooltip" data-original-title="منشور"><i class="fa fa-check"></i></a>';
                                        }
                                        ?>
                                        <a href="<?php echo ADMINURL . '/menus/show/' . $menu->menu_id; ?>" class="btn btn-xs btn-success" data-placement="top" data-toggle="tooltip" data-original-title="عرض"><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo ADMINURL . '/menus/edit/' . $menu->menu_id; ?>" class="btn btn-xs btn-primary" data-placement="top" data-toggle="tooltip" data-original-title="تعديل"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo ADMINURL . '/menus/delete/' . $menu->menu_id; ?>" class="btn btn-xs btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="حذف" onclick="return confirm('Are you sure?') ? true : false"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                            ...
                            <tr class="tab-selected">
                                ...
                                <th class="column-title"  colspan= "2"> عرض
                                    <select name="perpage" onchange="if (this.value)
                                                window.location.href = '<?php echo ADMINURL . '/menus/index/' . $data['current']; ?>' + '/' + this.value">
                ...
                <ul class="pagination text-center">
                    <?php
                    pagination($data['recordsCount'], $data['current'], $data['perpage'], 4, ADMINURL . '/menus');
                    ?>
                </ul>
