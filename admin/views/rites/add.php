...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_right">
            <h3><?php echo $data['page_title']; ?> <small>اضافة مناسك الحج والعمره </small></h3>
        </div>
    ...
    <div class="clearfix"></div>
    <div class="row">
        <form action="<?php echo ADMINURL . '/rites/add'; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            <div class="col-lg-8 col-sm-12 col-xs-12">
                ...
                <div class="form-group <?php echo (empty($data['image_error'])) ?: 'has-error'; ?>">
                    <label class="control-label" for="imageUpload"> الصورة  : </label>
                    <div class="has-feedback input-group">
                        <span class="input-group-btn">
                            <span class="btn btn-dark" onclick="$(this).parent().find('input[type=file]').click();">اختار الملف</span>
                            <input name="image" value="<?php echo ($data['image']); ?>" required onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;" type="file">
                        </span>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div id="collapseZero" class="collapse in card-body" aria-labelledby="headingZero">
                                ...
                                <!-- status -------------------------------------------------------------------------------------------------------- -->
                                <div class="form-group<?php echo (!empty($data['status_error'])) ? 'has-error' : ''; ?>">
                                    <div class="radio">
