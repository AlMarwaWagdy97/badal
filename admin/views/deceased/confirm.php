...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        <div class="title_right">
            <h3><?php echo $data['page_title']; ?> <small>  تاكيد حمله المتوفي </small></h3>
        </div>
    ...
    <div class="clearfix"></div>
    <div class="row">
        <div class="col-md-6col-sm-12 col-xs-12">
            ...
            <hr>
            <h4 for=""><b style="color: black;">المشروع : </b></h4>

            <form action="<?php echo ADMINURL . '/deceaseds/edit/'. $data['id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="pageTitle"> عنوان المشروع في كارت الاهداء : </label>
                        <div class="has-feedback">
                            <input type="text" class="form-control" name="gift_card_title" placeholder="عنوان المشروع في كارت الاهداء" value="<?php echo $data['gift_card_title']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
