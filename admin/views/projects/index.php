                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class=" form-group-sm">
                                ...
                                <th width="175px">
                                    <select class="form-control" name="search[deceased_id]">
                            ...
                            <tr class="headings">
                                ...
                                <th class="column-title">حمله المتوفي </th>
                        ...
                        <tbody>
                            <?php foreach ($data['projects'] as $project) : ?>
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        <?php echo ($project->deceased_id != null) ?
                                            '<a href="' . ADMINURL . '/deceaseds/show/' . $project->deceased_id . '"><i class="fa fa-eye btn btn-xs btn-primary"></i><a/>' : 
                                            // '<i class="fa fa-close m-1 btn btn-xs btn-primary"></i>';
                                            ''; ?>
                                    </td>
