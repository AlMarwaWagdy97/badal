...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <div class="title_left">
            <a href="<?php echo ADMINURL; ?>/notifications/add" class="btn btn-success pull-left">انشاء جديد <i class="fa fa-plus"></i></a>
        </div>
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <form action="" method="post">
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class=" form-group-sm">
                                ...
                                <th class=""><input type="search" class="form-control" placeholder="بحث بالمرسل" name="search[message]" value=""></th>
                            ...
                            <tr class="headings">
                                ...
                                <th class="column-title">محتوي الرسالة </th>
                        ...
                        <tbody>
                            <?php foreach ($data['notifications'] as $notification) : ?>
                                ...
                                <tr class="even pointer <?php echo $notification->status ? '' : ' selected '; ?>">
                                    <td class="a-center">
                                        <input type="checkbox" class="records flat" name="record[]" value="<?php echo $notification->notification_id; ?>">
                                    </td>
                                    <td class=""></td>
                                    <td class=""><?php echo $notification->subject; ?></td>
                                    <td class=""><?php echo $notification->message; ?></td>
                                    <td class="ltr"><?php echo date('Y/ m/ d | H:i a', $notification->create_date); ?></td>
                                    <td class="ltr"><?php echo date('Y/ m/ d | H:i a', $notification->modified_date); ?></td>
                                    <td width="100px">
                                        <?php
                                        echo '<a href="' . ADMINURL . '/notifications/publish/' . $notification->notification_id . '" class="btn btn-xs btn-success" type="button" data-toggle="tooltip" data-original-title="اعادة ارسال"><i class="fa  fa-envelope-o"></i></a>';

                                        ?>
                                        <a href="<?php echo ADMINURL . '/notifications/delete/' . $notification->notification_id; ?>" class="btn btn-xs btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="حذف" onclick="return confirm('Are you sure?') ? true : false"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            ...
                            <tr class="tab-selected">
                                ...
                                <th class="column-title"> عرض
                                    <select name="perpage" onchange="if (this.value)
                                                window.location.href = '<?php echo ADMINURL . '/notifications/index/' . $data['current']; ?>' + '/' + this.value">
                ...
                <ul class="pagination text-center">
                    <?php
                    pagination($data['recordsCount'], $data['current'], $data['perpage'], 4, ADMINURL . '/notifications');
                    ?>
                </ul>
