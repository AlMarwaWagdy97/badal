...
<div class="right_col" role="main">
    ...
    <div class="clearfix"></div>
    <div class="row">
        <form action="<?php echo ADMINURL . '/albadal/add'; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse card-body" aria-labelledby="headingOne">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="start_date" value="<?php echo $data['start_date'] != "" ? date("Y-m-d", $data['start_date']) : ""; ?>" placeholder="تاريخ بدأ النشر ">
                            </div>
                            <div class="form-group">
                                <label>تاريخ ايقاف النشر : </label>
                                <input type="date" class="form-control date" name="end_date" value="<?php echo  $data['end_date'] != "" ? date("Y-m-d", $data['end_date']) : ""; ?>" placeholder="تاريخ ايقاف النشر">
                            </div>
                            <div class="form-group">
                                <div class="radio">
