...
/**select all store list */
function checkallstores(check) {
    jQuery(check).parent().addClass('bg-info')
    if(jQuery(check).parent().hasClass('selected')){
        jQuery('input.flat.storecheck').removeAttr('checked');
        jQuery('.stores .icheckbox_flat-green').removeClass('checked');
    }else{
        jQuery('input.flat.storecheck').attr('checked', 'checked');
        jQuery('.stores .icheckbox_flat-green').addClass('checked');
