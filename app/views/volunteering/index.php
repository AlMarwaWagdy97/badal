                    ...
                    <div class="container-md projects">
                        <div class="projects-title">
                            <h1 class="project-heading btn m-0 bg-primary">
                                <a class="text-light" href="<?= URLROOT . '/projectCategories/show/' . $category->category_id . '-' . $category->name; ?>">
                                        ...
                                        <div class="project-details">
                                            <div class="target p-3">
                                                ...
                                                <div class="progress mt-3" style="height: 15px; direction:ltr">
                                                    <div data-toggle="tooltip" data-placement="top" title="<?= ceil($target * 100 / $project->target_price) . "%"; ?>" class="bg-success progress-bar-striped" role="progressbar" style="width: <?= ceil($target * 100 / $project->target_price) . "%"; ?>;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                        ...
                        <?php if ($category->level == 1) : ?>
                            <div class="project-category">
                                <div class="category-container my-3">
                                    ...
                                    <a href="<?= URLROOT . '/projectCategories/show/' . $category->category_id . '-' . $category->name; ?>" class="category-title">
                                        <h1 class="h6 my-2"><?= $category->name; ?></h1>
                                    </a>
                                    <p class="content text-secondary p-1 "><?= mb_substr(strip_tags($category->description), 0, 80); ?></p>
                                    <a class="btn btn-outline-secondary btn-sm mb-3 category-btn" href="<?= URLROOT . '/projectCategories/show/' . $category->category_id . '-' . $category->name; ?>">التفاصيل</a>
                                </div>
                            </div>
                    <?php endif;
                    endforeach; ?>
                ...
                <div class="col-lg-6 text-right pt-2">
                    <?php foreach ($data['articles'] as $article) : ?>
                        <div class="news bg-white row py-1 mb-1">
                            <a href="<?= URLROOT . '/articles/show/' . $article->article_id . '-' . $article->name; ?>" class="news-img col-3">
                            ...
                            <div class="news-content col-9">
                                ...
                                <small class="news-headline text-secondary">
                                    ...
                                    <a class="px-3" href="<?= URLROOT . '/articles/show/' . $article->article_id . '-' . $article->name; ?>">المزيد</a>
                                </small>
                            </div>
                        </div>
                        <!-- item -->
