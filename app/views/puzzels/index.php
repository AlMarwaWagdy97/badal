...
<div class="undermenu">
    ...
    <section id="articles" class="container text-center">
        <div class="row m-3 justify-content-center ">
            <div class="col">
                <h2 class="text-center"> <img src="<?php echo URLROOT; ?>/templates/default/images/namaa-icon.png" alt="Smiley face" class="ml-2">المقالات</h2>
            </div>
        </div>
        <div class="row">
            <?php
            ...
            ?>
                <div class="project-article col-lg-4 p-1">
                    <div class="article-container border">
                        ...
                        <a href="<?php echo URLROOT . '/articles/show/' . $article->article_id . '-' . $article->name; ?>" class="article-title">
                        ...
                        <a class="btn btn-outline-secondary btn-sm my-3 article-btn" href="<?php echo URLROOT . '/articles/show/' . $article->article_id . '-' . $article->name; ?>">التفاصيل</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
