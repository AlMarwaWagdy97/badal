...
<head>
    ...
    <!-- custom styles  -->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/templates/namaa/css/custom.css?v=0.0.16" />
    <!-- icofont iconss -->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/templates/namaa/css/icofont.min.css?v=0.0.3" />
        ...
        <div class="container-lg bg-white rounded py-0 d-flex">
            <nav class="navbar navbar-expand-lg navbar-light py-2">
                ...
                <a href="<?php echo URLROOT; ?>" class="navbar-brand font-weight-bold ml-auto pr-0">
                    <img class="" src="<?php echo empty($data['settings']['site']->logo) ? URLROOT . '/templates/namaa/images/logo.png' : MEDIAURL . '/' . $data['settings']['site']->logo; ?>" alt="<?php echo SITENAME; ?>" height="66" />
                </a>
                <div id="navbarContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="<?php echo URLROOT; ?>" class="nav-link active"><i class="icofont-home icofont-lg text-primary"></i> <span class="d-sm-inline d-lg-none">الرئيسية</span></a>
                        </li>
                        <?php
