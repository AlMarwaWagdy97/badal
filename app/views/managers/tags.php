...
<div class="container page">
    ...
    <section id="products">
                            ...
                            <div class="p-2">
                                ...
                                <small class=" pt-1 float-left"><span>المستهدف : </span>
                                    ...
                                    <?php if (empty($project->target_unit)) {
                                        echo '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                            viewBox="0 0 16 16" style="enable-background:new 0 0 16 16;width: 15px" xml:space="preserve">
                                                            <g>
                                                                <path d="M9.6,13.8L9.6,13.8c-0.2,0.5-0.4,1.1-0.5,1.7l5.1-1.1c0.2-0.5,0.4-1.1,0.5-1.7L9.6,13.8z" />
                                                                <path d="M14.2,11.2c0.2-0.5,0.4-1.1,0.5-1.7l-3.9,0.8V8.7L14.2,8c0.2-0.5,0.4-1.1,0.5-1.7l-3.9,0.8V1.3c-0.6,0.3-1.1,0.8-1.6,1.3
                                                                        v4.8L7.6,7.8V0.5C7,0.8,6.5,1.3,6,1.8v6.3L2.5,8.9C2.3,9.4,2.1,10,2,10.6l4-0.8v2l-4.3,0.9c-0.2,0.5-0.4,1.1-0.5,1.7l4.5-1
                                                                        c0.4-0.1,0.7-0.3,0.9-0.6l0.8-1.2l0,0c0.1-0.1,0.1-0.3,0.1-0.4V9.4L9.2,9v3.2L14.2,11.2L14.2,11.2z" />
                                                            </g>
                                                        </svg>';;
                                    } else {
                                        echo $project->target_unit;
        ...
        <div class="row ">
            <?php echo ($data['tag']->back_home) ? '<div class="col-md-6 mx-auto mt-2"><a class="w-100 btn btn-lg btn-secondary icofont-home" href="' . URLROOT . '/store/' . $data['store']->alias . '"> العودة الي الرئيسية</a></div>' : ''; ?>
        </div>
    </section>
    <!-- alertModal -->
