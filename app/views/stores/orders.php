        ...
        <div class="col-12">
            <form action="" method="post">
                    ...
                    <table class="table table-striped table-bordered rounded bulk_action">
                        <thead class="">
                            <tr>
                                <th class="bulk-actions" colspan="14">
                                    ...
                                    <span class="dropdown check-list mx-3">
                                        <a href="#" data-toggle="dropdown" class="dropdown-toggle text-black"> الحالات <b class="caret"></b></a>
                                        <ul class="dropdown-menu">
                                            <?php foreach ($data['statuses'] as $status) {
                                                echo '<li>
                                                    <button type="submit" name="status_id"  value="' . $status->status_id . '" class="btn btn-primary btn-sm m-1">' . $status->name . '</button> 
                                                </li>';
                                            } ?>
                                        </ul>
                                    </span>
                        ...
                        <tbody>
                            ...
                            <tr class="tab-selected">
                                ...
                                <th class="column-title" colspan="9"> عرض
                                    <select name="perpage" onchange="if (this.value)
                                                window.location.href = '<?php echo URLROOT . '/stores/orders/' . $data['current']; ?>' + '/' + this.value">
                ...
                <ul class="pagination text-center navigation ">
                    <?php
                    pagination($data['recordsCount'], $data['current'], $data['perpage'], 4, URLROOT . '/stores/', 'orders');
                    ?>
                </ul>
            </form>
        </div>
