...
<div class="text-center py-5 mb-0 undermenu  bg-success text-light h3 bg-battern">
    <h3 class="py-4 mt-4"> إضافة مستفيد بالجمعية </h3>
</div>
<div class="bg-light">
    <div class="container text-right py-2">
        ...
        <div class="row justify-content-md-center">
            <div class="col-lg-12 py-3">
                <?php if (@exist($data['settings']['notifications']->beneficiaryContent)) echo $data['settings']['notifications']->beneficiaryContent; ?>
            </div>
            <div class="col-lg-6 col-sm-12 py-5">
                <form action="<?php echo URLROOT . '/pages/beneficiaries'; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="needs-validation">
                    <div class="form-group">
                        <label class="control-label" for="pageTitle">اسم المستفيد : </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php if (!empty($data['city_error'])) echo 'is-invalid'; ?>" name="city" placeholder=" المدينة" value="<?php echo $data['city']; ?>">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="pageTitle">عدد افراد الاسرة : </label>
                        <input type="text" class="form-control <?php if (!empty($data['family_error'])) echo 'is-invalid'; ?>" name="family" placeholder=" عدد افراد الاسرة" value="<?php echo $data['family']; ?>">
                        <span class="invalid-feedback"><?php echo $data['family_error']; ?></span>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="pageTitle">الدخل : </label>
                        <input type="text" class="form-control <?php if (!empty($data['income_error'])) echo 'is-invalid'; ?>" name="income" placeholder=" الدخل" value="<?php echo $data['income']; ?>">
                        <span class="invalid-feedback"><?php echo $data['income_error']; ?></span>
                    </div>
                    <div class="form-group">
                        <label class="control-label">نوع الاحتياج المطلوب : </label>
                        <select class="form-control <?php if (!empty($data['message_error'])) echo 'is-invalid'; ?>" name="message" id="message">
                            <option value=""></option>
                            <option <?php if ($data['message'] == "سداد دين") echo  'selected'; ?> value="سداد دين">سداد دين</option>
                            <option <?php if ($data['message'] == "سداد متأخرات ايجار") echo  'selected'; ?> value="سداد متأخرات ايجار">سداد متأخرات ايجار</option>
                            <option <?php if ($data['message'] == "سداد فاتورة كهرباء") echo  'selected'; ?> value="سداد فاتورة كهرباء">سداد فاتورة كهرباء</option>
                            <option <?php if ($data['message'] == "توظيف") echo  'selected'; ?> value="توظيف">توظيف</option>
                            <option <?php if ($data['message'] == "اجهزة كهربائية") echo  'selected'; ?> value="اجهزة كهربائية">اجهزة كهربائية</option>
                            <option <?php if ($data['message'] == "تسجيل بالجمعية كمستفيد دائم") echo  'selected'; ?> value="تسجيل بالجمعية كمستفيد دائم">تسجيل بالجمعية كمستفيد دائم</option>
                        </select>
